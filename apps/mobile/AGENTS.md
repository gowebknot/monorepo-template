...
- Invoke the `authentication-rbac` skill before changing authentication, protected navigation,
  roles, permissions, or authorization UX. React Navigation checks are presentation only; the API
