...
- Invoke the `authentication-rbac` skill before changing authentication, protected Expo Router
  layouts, roles, permissions, or authorization UX. Navigation gating must never replace API-side
  authorization.
