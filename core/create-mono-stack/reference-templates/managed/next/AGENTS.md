...
- Invoke the `authentication-rbac` skill before changing generated login, sessions, protected App
  Router segments, roles, permissions, or authorization UX. Keep private data checks on the server;
  client and layout guards only complement them.
